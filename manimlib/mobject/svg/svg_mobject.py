...
class SVGMobject(VMobject):
    ...
    def ensure_valid_file(self):
        ...
        possible_paths = [
            os.path.join(os.path.join("assets", "svg"), self.file_name),
            os.path.join(os.path.join("assets", "svg"), self.file_name + ".svg"),
            os.path.join(os.path.join("assets", "svg"), self.file_name + ".xdv"),
            self.file_name,
        ]
